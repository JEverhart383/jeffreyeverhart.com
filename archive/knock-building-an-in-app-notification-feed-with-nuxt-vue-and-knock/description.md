...
Source: https://www.youtube.com/watch?v=lMVnYHy8HdY
Captured: 2026-09-13

---

In this video, we’ll look at how to build an entirely custom in-app feed experience inspired by Notion using Knock’s JavaScript client and real-time feed API. The example app is built using Nuxt.js and shadcn/ui, and you can find it on our GitHub here: https://github.com/knocklabs/nuxt-feed-example
